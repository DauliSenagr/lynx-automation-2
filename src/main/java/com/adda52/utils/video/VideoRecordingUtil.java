package com.adda52.utils.video;
...
public class VideoRecordingUtil extends ScreenRecorder {
    ...
    public VideoRecordingUtil(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat,
    ...
    public static void startRecording(String methodName) throws Exception {
        File file = new File("test-output/Recordings");
